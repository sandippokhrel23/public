...
-- Dumping structure for table application1.admin
...
-- Dumping data for table application1.admin: ~7 rows (approximately)
...
-- Dumping structure for table application1.appointment
...
-- Dumping data for table application1.appointment: ~66 rows (approximately)
...
-- Dumping structure for table application1.billing
...
-- Dumping data for table application1.billing: ~34 rows (approximately)
...
-- Dumping structure for table application1.billing_records
...
-- Dumping data for table application1.billing_records: ~203 rows (approximately)
...
INSERT INTO `billing_records` (`billingservice_id`, `billingid`, `bill_type_id`, `bill_type`, `bill_amount`, `bill_date`, `status`) VALUES
	...
	(205, 29, 35, 'Consultancy Charge', 700.00, '2019-04-01', 'Active'),
	(206, 29, 13, 'Treatment', 450.00, '2019-04-01', 'Active'),
	(207, 29, 13, 'Treatment', 450.00, '2019-04-01', 'Active');
/*!40000 ALTER TABLE `billing_records` ENABLE KEYS */;

-- Dumping structure for table application1.department
...
-- Dumping data for table application1.department: ~16 rows (approximately)
...
-- Dumping structure for table application1.doctor
...
-- Dumping data for table application1.doctor: ~14 rows (approximately)
...
-- Dumping structure for table application1.doctor_timings
...
-- Dumping data for table application1.doctor_timings: ~15 rows (approximately)
...
-- Dumping structure for table application1.medicine
...
-- Dumping data for table application1.medicine: ~5 rows (approximately)
...
-- Dumping structure for table application1.orders
...
-- Dumping data for table application1.orders: ~38 rows (approximately)
...
-- Dumping structure for table application1.patient
...
-- Dumping data for table application1.patient: ~22 rows (approximately)
...
INSERT INTO `patient` (`patientid`, `patientname`, `admissiondate`, `admissiontime`, `address`, `mobileno`, `city`, `pincode`, `loginid`, `password`, `bloodgroup`, `gender`, `dob`, `status`) VALUES
	...
	(58, 'Roshan Bhandari', '2019-04-01', '15:29:31', 'asdf', 'asdfasdf', 'asdfads', 'asdfa', 'roxxon', 'nepal123', 'A+', 'MALE', '2019-04-01', 'Active'),
	(59, 'Sandip', '2019-04-07', '15:16:44', 'ktm', '9898989898', 'abc', '1111', 'sandip', '123456', 'B-', 'MALE', '2019-03-01', 'Active'),
	(60, 'Roshan Bhandari', '2019-04-07', '15:18:03', 'hhgghghg', '9898989898', 'asdfads', '1111', 'sandip', '1234567890', 'B+', 'MALE', '2019-01-03', 'Active');
/*!40000 ALTER TABLE `patient` ENABLE KEYS */;

-- Dumping structure for table application1.payment
...
-- Dumping data for table application1.payment: ~45 rows (approximately)
...
-- Dumping structure for table application1.prescription
CREATE TABLE IF NOT EXISTS `prescription` (
  `prescriptionid` int(10) NOT NULL AUTO_INCREMENT,
  `treatment_records_id` int(10) NOT NULL,
  `prescriptionenddate` date DEFAULT NULL,
  `doctorid` int(10) NOT NULL,
  `patientid` int(10) NOT NULL,
...
-- Dumping data for table application1.prescription: ~83 rows (approximately)
/*!40000 ALTER TABLE `prescription` DISABLE KEYS */;
INSERT INTO `prescription` (`prescriptionid`, `treatment_records_id`, `prescriptionenddate`, `doctorid`, `patientid`, `delivery_type`, `delivery_id`, `med_name`, `med_time`, `prescriptiondate`, `status`, `appointmentid`) VALUES
	(15, 0, NULL, 35, 7, '', 0, NULL, NULL, '2015-08-14', 'Active', 0),
	(16, 0, NULL, 36, 9, '', 0, NULL, NULL, '2016-01-08', 'Active', 0),
	(17, 0, NULL, 37, 22, '', 0, NULL, NULL, '2015-11-14', 'Active', 0),
	(18, 0, NULL, 38, 23, '', 0, NULL, NULL, '2016-02-27', 'Active', 0),
	(19, 0, NULL, 40, 36, '', 0, NULL, NULL, '2015-12-12', 'Active', 0),
	(20, 14, NULL, 36, 22, '', 0, NULL, NULL, '2016-03-11', 'Active', 0),
	(21, 44, NULL, 36, 22, '', 0, NULL, NULL, '2016-03-11', 'Active', 0),
	(22, 14, NULL, 35, 47, '', 0, NULL, NULL, '2016-03-19', 'Active', 0),
	(23, 14, NULL, 35, 47, '', 0, NULL, NULL, '2016-03-19', 'Active', 0),
	(24, 13, NULL, 35, 47, '', 0, NULL, NULL, '2016-03-09', 'Active', 0),
	(25, 13, NULL, 37, 47, '', 0, NULL, NULL, '2016-03-09', 'Active', 0),
	(26, 13, NULL, 36, 48, '', 0, NULL, NULL, '2016-03-25', 'Active', 0),
	(27, 13, NULL, 35, 48, '', 0, NULL, NULL, '2016-03-25', 'Active', 0),
	(28, 13, NULL, 35, 48, '', 0, NULL, NULL, '2016-03-25', 'Active', 0),
	(29, 0, NULL, 0, 48, '', 0, NULL, NULL, '2016-03-27', 'Active', 0),
	(30, 0, NULL, 0, 48, '', 0, NULL, NULL, '2016-03-27', 'Active', 0),
	(31, 0, NULL, 0, 48, '', 0, NULL, NULL, '2016-03-27', 'Active', 0),
	(32, 0, NULL, 0, 48, '', 0, NULL, NULL, '2016-03-27', 'Active', 0),
	(33, 0, NULL, 37, 48, '', 0, NULL, NULL, '2016-03-27', 'Active', 0),
	(34, 0, NULL, 37, 48, '', 0, NULL, NULL, '2016-03-27', 'Active', 0),
	(35, 0, NULL, 37, 48, '', 0, NULL, NULL, '2016-03-27', 'Active', 0),
	(36, 14, NULL, 35, 43, '', 0, NULL, NULL, '2018-03-24', 'Pending', 0),
	(37, 13, NULL, 35, 43, '', 0, NULL, NULL, '2018-03-26', 'Pending', 0),
	(38, 14, NULL, 36, 47, '', 0, NULL, NULL, '2018-03-27', 'Pending', 0),
	(39, 14, NULL, 37, 9, '', 0, NULL, NULL, '2018-03-27', 'Pending', 0),
	(40, 14, NULL, 37, 9, '', 0, NULL, NULL, '2018-03-27', 'Pending', 0),
	(41, 14, NULL, 37, 9, '', 0, NULL, NULL, '2018-03-27', 'Pending', 0),
	(42, 13, NULL, 37, 9, '', 0, NULL, NULL, '2018-03-27', 'Active', 0),
	(43, 13, NULL, 36, 47, '', 0, NULL, NULL, '2018-03-27', 'Pending', 0),
	(44, 0, NULL, 35, 22, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(45, 0, NULL, 35, 7, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(46, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-28', 'Active', 0),
	(47, 0, NULL, 35, 41, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(48, 44, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-30', 'Active', 0),
	(49, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-30', 'Active', 0),
	(50, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-30', 'Active', 0),
	(51, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-30', 'Active', 0),
	(52, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-30', 'Active', 0),
	(53, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-30', 'Active', 0),
	(54, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-30', 'Active', 0),
	(57, 0, NULL, 38, 41, '', 0, NULL, NULL, '2018-03-31', 'Active', 0),
	(58, 19, NULL, 37, 56, '', 0, NULL, NULL, '2018-03-31', 'Active', 0),
	(59, 19, NULL, 38, 56, '', 0, NULL, NULL, '2018-03-31', 'Active', 0),
	(60, 14, NULL, 38, 54, '', 0, NULL, NULL, '2018-03-31', 'Active', 0),
	(61, 0, NULL, 35, 7, '', 0, NULL, NULL, '2018-03-31', 'Active', 0),
	(62, 0, NULL, 35, 7, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(63, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(64, 13, NULL, 35, 48, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(65, 0, NULL, 35, 7, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(66, 0, NULL, 35, 41, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(67, 0, NULL, 35, 41, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(68, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(69, 14, NULL, 35, 22, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(70, 44, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(71, 0, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(72, 0, NULL, 0, 36, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(73, 0, NULL, 0, 48, '', 0, NULL, NULL, '2018-03-27', 'Active', 0),
	(74, 0, NULL, 36, 7, '', 0, NULL, NULL, '2018-04-27', 'Active', 0),
	(75, 0, NULL, 36, 7, '', 0, NULL, NULL, '2018-04-12', 'Active', 0),
	(76, 13, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-03', 'Active', 0),
	(77, 13, NULL, 36, 47, '', 0, NULL, NULL, '2018-04-04', 'Active', 0),
	(78, 14, NULL, 36, 44, '', 0, NULL, NULL, '2018-04-04', 'Active', 0),
	(79, 14, NULL, 35, 44, '', 0, NULL, NULL, '0000-00-00', 'Active', 0),
	(80, 14, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-04', 'Active', 0),
	(81, 13, NULL, 35, 56, '', 0, NULL, NULL, '2018-04-06', 'Active', 0),
	(82, 0, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-06', 'Active', 0),
	(83, 0, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-06', 'Active', 0),
	(84, 0, NULL, 35, 7, '', 0, NULL, NULL, '2018-04-13', 'Active', 0),
	(85, 0, NULL, 35, 52, '', 0, NULL, NULL, '2018-04-06', 'Active', 0),
	(86, 0, NULL, 35, 53, '', 0, NULL, NULL, '2018-04-07', 'Active', 0),
	(87, 0, NULL, 35, 53, '', 47, NULL, NULL, '2018-04-10', 'Active', 0),
	(88, 0, NULL, 35, 52, '', 48, NULL, NULL, '2018-04-07', 'Active', 0),
	(89, 0, NULL, 36, 22, '', 49, NULL, NULL, '2018-04-07', 'Active', 0),
	(90, 0, NULL, 35, 7, '', 42, NULL, NULL, '0000-00-00', 'Active', 0),
	(91, 0, NULL, 35, 22, '', 50, NULL, NULL, '2018-04-08', 'Active', 0),
	(92, 0, NULL, 35, 22, '', 51, NULL, NULL, '2018-04-10', 'Active', 0),
	(93, 0, NULL, 36, 22, '', 49, NULL, NULL, '2018-04-10', 'Active', 0),
	(94, 0, NULL, 35, 22, '', 52, NULL, NULL, '2018-04-08', 'Active', 0),
	(95, 0, NULL, 35, 22, '', 53, NULL, NULL, '2018-04-08', 'Active', 0),
	(96, 0, NULL, 35, 22, '', 54, NULL, NULL, '2018-04-08', 'Active', 0),
	(97, 0, NULL, 35, 22, '', 55, NULL, NULL, '2018-04-08', 'Active', 0),
	(98, 0, NULL, 35, 57, '', 0, NULL, NULL, '0000-00-00', 'Active', 120),
	(99, 0, NULL, 35, 57, '', 0, NULL, NULL, '2018-07-12', 'Active', 120),
	(100, 61, NULL, 35, 22, NULL, NULL, NULL, NULL, '2019-04-01', 'Active', 82),
	(101, 61, NULL, 35, 22, NULL, NULL, NULL, NULL, '2019-04-01', 'Active', 82);
/*!40000 ALTER TABLE `prescription` ENABLE KEYS */;

-- Dumping structure for table application1.prescription_records
...
-- Dumping data for table application1.prescription_records: ~116 rows (approximately)
...
-- Dumping structure for table application1.room
...
-- Dumping data for table application1.room: ~5 rows (approximately)
...
-- Dumping structure for table application1.service_type
...
-- Dumping data for table application1.service_type: ~5 rows (approximately)
...
-- Dumping structure for table application1.treatment
...
-- Dumping data for table application1.treatment: ~7 rows (approximately)
...
-- Dumping structure for table application1.treatment_records
...
-- Dumping data for table application1.treatment_records: ~49 rows (approximately)
...
INSERT INTO `treatment_records` (`treatment_records_id`, `treatmentid`, `appointmentid`, `patientid`, `doctorid`, `treatment_description`, `uploads`, `treatment_date`, `treatment_time`, `status`) VALUES
	...
	(60, 13, 82, 22, 35, 'aa', '1688985349', '2019-04-01', '02:01:00', 'Active'),
	(61, 13, 82, 22, 35, 'aa', '1688985349', '2019-04-01', '02:01:00', 'Active');
/*!40000 ALTER TABLE `treatment_records` ENABLE KEYS */;

-- Dumping structure for table application1.user
...
-- Dumping data for table application1.user: ~0 rows (approximately)
